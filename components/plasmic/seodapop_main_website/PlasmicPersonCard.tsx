...
import sty from "./PlasmicPersonCard.module.css"; // plasmic-import: qxI8sK4vboidUg/css
  ...
  const args = React.useMemo(
    () =>
      Object.assign(
        {
          image: {
            src: "/plasmic/seodapop_main_website/images/team2Jpg2.jpg",
            fullWidth: 400,
            fullHeight: 400,
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__cI3Ew)}
      >
        <h1
        ...
        <div className={classNames(projectcss.all, sty.freeBox__oCL)}>
          {p.renderPlasmicSlot({
        ...
        {true ? (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__ho4DT)}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  {true ? (
                    ...
                    >
                      <IconIcon
                        className={classNames(projectcss.all, sty.svg__adivf)}
                  ...
                  >
                    <Icon2Icon
                      className={classNames(projectcss.all, sty.svg__shGz)}
                      role={"img"}
                    />
                  </p.PlasmicLink>
                  <p.PlasmicLink
                  ...
                  >
                    <Icon3Icon
                      className={classNames(projectcss.all, sty.svg__vKkxA)}
                      role={"img"}
                    />
                  </p.PlasmicLink>
                </React.Fragment>
