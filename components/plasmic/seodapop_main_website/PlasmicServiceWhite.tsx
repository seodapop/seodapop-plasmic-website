...
import sty from "./PlasmicServiceWhite.module.css"; // plasmic-import: h9Deuef5XKQXuA/css
  ...
  return (
    true ? (
      ...
      >
        ...
        <div className={classNames(projectcss.all, sty.freeBox___4QQp)}>
          {p.renderPlasmicSlot({
            defaultContents: (
              <BlueBdr
                className={classNames("__wab_instance", sty.blueBdr__jfHH)}
              />
            ),
        ...
        <div className={classNames(projectcss.all, sty.freeBox___5CCBq)}>
          {p.renderPlasmicSlot({
            defaultContents:
