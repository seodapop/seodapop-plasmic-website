...
import sty from "./PlasmicSocialIcons.module.css"; // plasmic-import: 2QVDVqcx9ajv7/css
...
function PlasmicSocialIcons__RenderFunc(props: {
  ...
  return (
    true ? (
      ...
      >
        <IconIcon
          className={classNames(projectcss.all, sty.svg__xuLgB)}
        ...
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__stKqn)}
          role={"img"}
        />

        <Icon3Icon
          className={classNames(projectcss.all, sty.svg__z9LBu)}
          role={"img"}
        />
      </p.Stack>
    ) : null
